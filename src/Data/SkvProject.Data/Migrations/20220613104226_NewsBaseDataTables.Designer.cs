...
namespace SkvProject.Data.Migrations
{
    ...
    [Migration("20220613104226_NewsBaseDataTables")]
    partial class NewsBaseDataTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkvProject.Data.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("SkvProject.Data.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SkvProject.Data.Models.Forum.FavoritePost", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SkvProject.Data.Models.Forum.Vote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("SkvProject.Data.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SkvProject.Data.Models.ApplicationUser", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("SkvProject.Data.Models.Forum.Comment", b =>
                {
                    ...
                    b.HasOne("SkvProject.Data.Models.Forum.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("SkvProject.Data.Models.Forum.FavoritePost", b =>
                {
                    ...
                    b.HasOne("SkvProject.Data.Models.ApplicationUser", "User")
                        .WithMany("FavoritePosts")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
